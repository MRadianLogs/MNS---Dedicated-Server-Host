...
public class Server
{
    ...
    public delegate void PacketHandler(int clientOrigin, Packet packet);
    ...
    public static void Start(int maxNumPlayers, int portNum)
    {
        ...
        tcpListener.BeginAcceptTcpClient(new AsyncCallback(TCPConnectCallback), null); //Waits for new connection in different thread.
    ...
    private static void TCPConnectCallback(IAsyncResult result)
    {
        ...
        {
            if (clients[i].tcp.socket == null) //If that position isnt already taken,
            {
